...
Begin VB.Form frmModifikimeGjeneralitete 
   ...
   Begin VB.CommandButton cmdShfaq 
      ...
      Width           =   2295
   End
   Begin VB.CommandButton cmdModifikoSjellje 
      BackColor       =   &H80000009&
      Caption         =   "Modifiko sjellje"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   12
         Charset         =   0
   ...
   Begin RichTextLib.RichTextBox rtbSjellja 
      ...
      Enabled         =   -1  'True
      Appearance      =   0
      TextRTF         =   $"frmModifikimeGjeneralitete.frx":6F75
   End
...
Private Sub cboVitiShkollor_Change()
    rtbSjellja.Text = ""
End Sub
...
Private Sub cmdModifikoSjellje_Click()
    objectInitialization MODIFIKO_SHENIME_BUTONI_KLIK
End Sub
...
Private Sub cmdShfaq_Click()
  If cboVitiShkollor.Text <> "" Then
   ...
   If objektGabimi.mvarGabimi = 0 Or objektGabimi.mvarGabimi = 19 Or objektGabimi.mvarGabimi = 20 Then
      rtbSjellja.Text = ""
      objectInitialization MODIFIKO_SHENIME_SHFAQ
   Else
      objektGabimi.menazhim_gabimi
   End If
  Else
    MsgBox "Para se te modifikoni shenimet zgjidhni vitin shkollor.", , "Modifikimi i sjelljeve."
  End If
End Sub
